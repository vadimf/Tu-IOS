...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        disableMachineMonitoringIfNeeded()
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        if !NetworkManager.shared.isConnceted {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        enableMachineMonitoringIfNeeded()
    }
    ...
    // MARK: - Monitoring Utility Methods

    private func enableMachineMonitoringIfNeeded() {
        let monitor = MachineMonitor.shared
        if monitor.isConnected {
            monitor.startMonitoring()
        }
    }
    
    private func disableMachineMonitoringIfNeeded() {
        let monitor = MachineMonitor.shared
        if monitor.isConnected {
